...
public class ProdiPresenter {
    ...
    public ProdiPresenter(ProdiView viewObject) {
        this.viewObject = viewObject;
    }

    public ProdiPresenter(ProdiListView viewResult) {
        this.viewResult = viewResult;
    }

    public ProdiPresenter(ProdiWorkView viewEditor) {
